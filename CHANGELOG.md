## [3.0.4](https://github.com/holydrug/semantic-memory-mcp/compare/v3.0.3...v3.0.4) (2026-03-17)


### Bug Fixes

* use spawn with stdin.end() for Claude CLI subprocess (prevents hang) ([d3ec661](https://github.com/holydrug/semantic-memory-mcp/commit/d3ec661771ed4876a3de6bee237e3a77a6c2bf04))

## [3.0.3](https://github.com/holydrug/semantic-memory-mcp/compare/v3.0.2...v3.0.3) (2026-03-17)


### Bug Fixes

* replace NULLS FIRST with coalesce in Cypher ORDER BY (Neo4j compat) ([fede4c3](https://github.com/holydrug/semantic-memory-mcp/commit/fede4c3399b5d2144a40722d5f6e00a81dd2eef7))

## [3.0.2](https://github.com/holydrug/semantic-memory-mcp/compare/v3.0.1...v3.0.2) (2026-03-17)


### Bug Fixes

* route to v3 init when config.json exists, detect cwd config in resolveDataDir ([4632097](https://github.com/holydrug/semantic-memory-mcp/commit/463209730eb1943f1f53c7a842026ab62e064c58))
