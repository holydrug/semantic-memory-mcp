...
Added automatically by `npx semantic-memory-mcp@0.9.0 init`. Config lives in `~/.claude.json`:
...
You can also configure triggers interactively during `npx semantic-memory-mcp@0.9.0 init`.
